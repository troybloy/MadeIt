    ...
    <div className='splashPage-all'>
      <div className='splash-page-container'>
        <div className='SP-banner'>
          {' '}
          {shopsArray.length > 0 ? (
            <div className='SP-shops-header'>
              Find things you'll love. Support Troy. Here are some featured
              MadeIt stores!
            </div>
          ) : (
            <div className='SP-no-shops-header'>
              We seem to have no MadeIt shops at this time.
            </div>
          )}
      ...
      <div className='SP-items-header-container'>
        {' '}
        {itemsArray.length > 0 ? (
          <div className='SP-items-header'>Featured Items</div>
        ) : (
          <div className='SP-no-items-header'>
            We seem to have no items at this time.
          </div>
        )}
      </div>
